...
define('DOMAIN_URL', 'https://awesomearts.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_awesome_arts";  // Change as required
    private $db_pass = "Awesome_arts@2024";  // Change as required
    private $db_name = "u743445510_awesome_arts";    // Change as required
