...
<section class="content-header">
    <h1>Awesome Arts Purchase Code <a href='purchase-code.php'></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                    <form id="validate_code_website" method="GET">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Enter the Purchase Code shared by the customer for Awesome Arts</label>
